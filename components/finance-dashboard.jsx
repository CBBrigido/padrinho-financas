  ...
  return (
    <div className="pf-outer" style={{ background: "#13151A", minHeight: "100vh", display: "flex", fontFamily: "'DM Sans', 'Segoe UI', sans-serif", color: "#F0F2F5" }}>
      <style>{`
        ...
        .pf-date-input { width: 130px; }
        .pf-date-input::-webkit-calendar-picker-indicator {
          filter: invert(58%) sepia(90%) saturate(400%) hue-rotate(90deg) brightness(110%);
          cursor: pointer;
          padding-left: 200px;
          margin-left: -200px;
        }
              ...
              <div key={tx.id} style={s.txRow}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: 11, color: "#8E99A9" }}>{new Date(tx.date.slice(0,10) + "T12:00:00").toLocaleDateString("pt-BR")}</div>
                  </div>
                </div>
